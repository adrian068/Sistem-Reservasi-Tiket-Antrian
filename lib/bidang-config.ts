...
export const BIDANG_CONFIG: Record<BidangSlug, BidangUiConfig> = {
  paud: {
    ...
    label: 'PAUD',
    shortLabel: 'PAUD',
    defaultAdminNama: 'Petugas Bidang PAUD',
  ...
  ptk: {
    ...
    label: 'PTK',
    shortLabel: 'PTK',
    defaultAdminNama: 'Petugas Bidang PTK',
    accentBorder: 'border-brand-border-light dark:border-brand-header-dark',
    accentBg: 'bg-brand-light-bg/80 dark:bg-brand-header-dark/30',
    accentText: 'text-brand-primary',
    accentIconBg: 'bg-brand-light dark:bg-brand-header-dark',
    accentButton: 'bg-brand-primary hover:bg-brand-accent-hover',
  },
  'sd-umum': {
    slug: 'sd-umum',
    serviceKey: 'sd',
    label: 'SD Umum',
    shortLabel: 'SD',
    defaultAdminNama: 'Petugas Bidang SD',
  ...
  'smp-umum': {
    ...
    label: 'SMP Umum',
    shortLabel: 'SMP',
    defaultAdminNama: 'Petugas Bidang SMP',
