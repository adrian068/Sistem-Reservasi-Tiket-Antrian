...
export function PaudSchedulePanel() {
        ...
        <div className="flex items-start justify-between gap-3">
          <div>
            ...
            <p className="text-sm text-muted-foreground mt-1">
              Jam operasional dan tamu per slot hari ini
            </p>
          </div>
          <Button
            variant="outline"
      ...
      <CardContent className="space-y-4">
        {loading && !data ? (
          ...
          <>
            ...
            {data.jadwal ? (
              <div className="rounded-lg bg-orange-50/80 dark:bg-orange-950/20 border border-orange-200/60 dark:border-orange-900/40 px-3 py-2.5">
                    ...
                    >
                      <div className="flex items-center justify-between gap-2">
                        ...
                        <div className="text-right">
                          {isNow && (
                            <Badge className="bg-orange-500 hover:bg-orange-500 mb-1">
                              Sekarang
                            </Badge>
                          )}
                          <Badge
                      ...
                      {slot.tamu.length > 0 && (
                        <ul className="mt-2 space-y-1 border-t border-border/60 pt-2">
                          {slot.tamu.map((t) => (
                            ...
                            >
                              <span>
                                <strong className="text-orange-600">{t.queueNumber}</strong>{" "}
                                {t.name}
                              </span>
